...
rounded-full px-8 md:px-10 h-12 md:h-14 w-full sm:w-auto text-white font-bold text-base md:text-lg border-none
...
hover:scale-105 transition-all duration-300"
          ...
          <button className="px-4 py-2 h-14 w-full sm:w-auto justify-center flex items-center font-bold text-blue-700 hover:bg-blue-700 border border-blue-700 rounded-full group transition-all duration-300 hover:bg-linear-to-r hover:from-blue-500 hover:to-purple-600 hover:text-white hover:border-transparent">
